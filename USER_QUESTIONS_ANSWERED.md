...
```
1. savedState has selectedRepo: '<private-repo>', selectedBranch: 'main'
...
```
1. savedState: selectedRepo='<private-repo>', selectedBranch='main'
2. loadCredentialsAndUpdateRepo sets state
3. useEffect fires → selectedRepo='<private-repo>' → loadItems called ONCE
