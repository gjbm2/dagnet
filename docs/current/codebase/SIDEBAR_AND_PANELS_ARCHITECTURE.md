...
## Note: Generic Panel System

The sidebar system is currently tightly coupled to GraphEditor (hardcoded panel IDs, components, and hook). A generic `usePanelDock` hook has been considered but not yet implemented.
