...
**Unavoidable** — edges need new screen coordinates to render at correct positions.
...
1. **Don't use EdgeLabelRenderer** — render all beads as pure SVG, no portals
...
Fundamental issue: **React portals + high-frequency coordinate updates = bad time**
