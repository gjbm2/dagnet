...
**Purpose**: How query DSL strings are used for data retrieval, and the critical cases where naive query construction fails.
...
- **Topology filtering**: `lib/graph_query.py`
