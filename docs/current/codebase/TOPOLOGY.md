...
Docs: [COHORT_ANALYSIS_NUMERATOR_DENOMINATOR_SEMANTICS.md](COHORT_ANALYSIS_NUMERATOR_DENOMINATOR_SEMANTICS.md) (semantics), [FORECAST_RUNTIME_ARCHITECTURE.md](FORECAST_RUNTIME_ARCHITECTURE.md) (runtime), [FORECAST_STACK_DATA_FLOW.md](FORECAST_STACK_DATA_FLOW.md) (I/O and persistence), [CF_PRIMITIVE_SUBSTRATE.md](CF_PRIMITIVE_SUBSTRATE.md) (substrate entry point), [CF_ROW_PIPELINE.md](CF_ROW_PIPELINE.md) (row engine, dual-prefix objects, selected-cohort reducer), [CF_DEFENSIVE_FINDINGS.md](CF_DEFENSIVE_FINDINGS.md) (audit summary), [CF_HOLD_OUT_ENGINES.md](CF_HOLD_OUT_ENGINES.md) (parallel paths + legacy), [CF_RESIDUAL_GUARD.md](CF_RESIDUAL_GUARD.md), [DRAW_FAMILY_KEYING.md](DRAW_FAMILY_KEYING.md), [CF_REFACTOR_TRACKERS.md](CF_REFACTOR_TRACKERS.md), [STATS_SUBSYSTEMS.md](STATS_SUBSYSTEMS.md) §3.3, [BE_RUNNER_CLUSTER.md](BE_RUNNER_CLUSTER.md), [FE_BE_STATS_PARALLELISM.md](FE_BE_STATS_PARALLELISM.md).
