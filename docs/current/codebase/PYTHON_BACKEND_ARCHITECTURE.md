...
| Endpoint | Method | Purpose |
|----------|--------|---------|
| `/api/stats-enhance` | POST | Statistical enhancement (MCMC, Bayesian inference, trend detection) |
...
| Endpoint | Method | Purpose |
|----------|--------|---------|
| `/api/lag/recompute-models` | POST | Recompute latency/lag fit models for edges |
| `/api/lag/topo-pass` | POST | Topology pass: aggregate lag data across cohort dates |
...
| `lib/stats_enhancement.py` | Statistical enhancement (trends, MCMC) |
