...
| 72 | [72-fe-cli-conditioned-forecast-parity-fix-plan.md](72-fe-cli-conditioned-forecast-parity-fix-plan.md) | **Active implementation plan** (23-Apr-26) | Execution plan for the FE/CLI conditioned-forecast parity defect cluster. Separates FE model-building from query conditioning, unifies runtime probability-source resolution, and makes graph-surface CF scenario-owned | Implementation not started. Depends on parity harnesses, runtime provenance checks, and a durable scenario-graph state contract |
