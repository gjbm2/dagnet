...
| 42b | [42b-asat-remedial-workplan.md](42b-asat-remedial-workplan.md) | **Active** (16-Apr-26) | Remedial workplan. D1 (duplicate fork), D5 (analysis sweep_to), D7 (slice key) — resolved. D2 (fit_history), D3 (historical completeness) — blocked. 43b (hash parity) — open. 14/14 blind tests pass |
...
| 43b | [43b-context-hash-parity-defect.md](43b-context-hash-parity-defect.md) | **Open** (16-Apr-26) | `computeQuerySignature` produces identical `core_hash` for bare and contexted queries. Likely AP 11: context keys resolved from graph config, not DSL clause. Blocks mixed-epoch synth regen. Affects all contexted graphs |
