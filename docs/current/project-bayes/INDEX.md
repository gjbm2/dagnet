...
| 72 | [72-fe-cli-conditioned-forecast-parity-fix-plan.md](72-fe-cli-conditioned-forecast-parity-fix-plan.md) | **Historical implementation note** (24-Apr-26) | Narrow FE/CLI parity investigation record retained for provenance. The current narrowed FE route now lives in docs 74-75 | Do not use as the primary execution note |
| 73 | [73-be-topo-removal-and-forecast-state-separation-plan.md](73-be-topo-removal-and-forecast-state-separation-plan.md) | **Broader alternative plan** (24-Apr-26) | Broader proposal for BE-topo removal and graph-state separation. Retained for background, but no longer the chosen narrow FE route for scenario/CF repair | Use only as background if the narrower doc 75 route proves insufficient |
| 74 | [74-doc-72-scope-correction.md](74-doc-72-scope-correction.md) | **Companion scope note** (24-Apr-26) | Short scoping note recorded after the reversion. Keeps doc 72's useful warning about crossing model state with query-scoped answers while explicitly de-scoping broader clean-up framing | Read alongside doc 75, not as a standalone implementation plan |
| 75 | [75-scenario-param-pack-and-cf-supersession-plan.md](75-scenario-param-pack-and-cf-supersession-plan.md) | **Active implementation plan** (24-Apr-26) | Current narrowed FE parity plan. Adds the missing execution stages for separating the FE provisional answer from model-bearing state, unifying Python probability resolution across target-edge and carrier reads, moving CF supersession to per-scenario tab state, and making thin scenario packs faithful enough to replace graph-stashed posterior inventory | Current execution note for the next FE parity/scenario repair attempt |
