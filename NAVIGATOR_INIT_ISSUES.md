...
**Evidence:**
- Line 39: `loadItems called with repo=<private-repo>, branch=main`
- Line 64: (in useEffect on state change)
- Line 174: `loadItems called with repo=<private-repo>, branch=main`
- Line 347: `loadItems called with repo=<private-repo>, branch=main`
- Line 503: `loadItems called with repo=<private-repo>, branch=main`
- Line 666: `loadItems called with repo=<private-repo>, branch=main`
...
2. Load from DB: `selectedRepo: '<private-repo>', selectedBranch: 'main'` → loadItems call #1
