#!/usr/bin/env bash
# Stage all changes, commit, and push the current branch in nous-conversion.
...
REPO_DIR="$(cd "$(dirname "$0")/../../nous-conversion" && pwd)"
...
echo "Create a PR at: https://github.com/gjbm2/nous-conversion/compare/$BRANCH?expand=1"
