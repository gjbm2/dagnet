#!/usr/bin/env bash
# Validate consistency between entity files and index files in the data repo.
...
REPO_DIR="$DATA_REPO_PATH"
ERRORS=0

echo "==> Validating data repo at: $REPO_DIR"
echo ""
