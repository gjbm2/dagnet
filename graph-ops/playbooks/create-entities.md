...
How to create individual entity files (node, event, parameter, context) in `<private-repo>`.
...
grep -i "<event-name>" <private-repo>/events-index.yaml

# Check existing nodes
grep -i "<node-name>" <private-repo>/nodes-index.yaml

# Check existing parameters
grep -i "<param-name>" <private-repo>/parameters-index.yaml
```
...
**File**: `<private-repo>/events/<id>.yaml`
...
Add to `<private-repo>/events-index.yaml` under `events:`:
...
**File**: `<private-repo>/nodes/<id>.yaml`
...
Add to `<private-repo>/nodes-index.yaml` under `nodes:`:
...
**File**: `<private-repo>/parameters/<id>.yaml`
...
Add to `<private-repo>/parameters-index.yaml` under `parameters:`:
...
**File**: `<private-repo>/contexts/<id>.yaml`
...
Check `<private-repo>/contexts-index.yaml` — current contexts are:
...
Add to `<private-repo>/contexts-index.yaml` under `contexts:`.
