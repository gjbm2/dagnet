...
import {
  SCENARIO_PALETTE,
  SCENARIO_PALETTE_OPTIONS,
  generatePaletteColours,
  type ScenarioColourPalette,
} from './scenarioPalette';
...
export function ScenariosProvider({ children, fileId, tabId }: ScenariosProviderProps) {
  ...
  /**
   * Recolour all scenarios using the given palette.
