...
export function enhanceGraphLatencies(
  ...
  const MODEL: ForecastingModelSettings = {
    ...
    BAYES_LOG_KAPPA_MU: forecasting?.BAYES_LOG_KAPPA_MU ?? BAYES_LOG_KAPPA_MU,
    BAYES_LOG_KAPPA_SIGMA: forecasting?.BAYES_LOG_KAPPA_SIGMA ?? BAYES_LOG_KAPPA_SIGMA,
    BAYES_FALLBACK_PRIOR_ESS: forecasting?.BAYES_FALLBACK_PRIOR_ESS ?? BAYES_FALLBACK_PRIOR_ESS,
    BAYES_DIRICHLET_CONC_FLOOR: forecasting?.BAYES_DIRICHLET_CONC_FLOOR ?? BAYES_DIRICHLET_CONC_FLOOR,
    BAYES_SIGMA_FLOOR: forecasting?.BAYES_SIGMA_FLOOR ?? BAYES_SIGMA_FLOOR,
    BAYES_MU_PRIOR_SIGMA_FLOOR: forecasting?.BAYES_MU_PRIOR_SIGMA_FLOOR ?? BAYES_MU_PRIOR_SIGMA_FLOOR,
    BAYES_MATURITY_FLOOR: forecasting?.BAYES_MATURITY_FLOOR ?? BAYES_MATURITY_FLOOR,
    BAYES_SOFTPLUS_SHARPNESS: forecasting?.BAYES_SOFTPLUS_SHARPNESS ?? BAYES_SOFTPLUS_SHARPNESS,
    BAYES_RHAT_THRESHOLD: forecasting?.BAYES_RHAT_THRESHOLD ?? BAYES_RHAT_THRESHOLD,
    BAYES_ESS_THRESHOLD: forecasting?.BAYES_ESS_THRESHOLD ?? BAYES_ESS_THRESHOLD,
    BAYES_WARM_START_RHAT_MAX: forecasting?.BAYES_WARM_START_RHAT_MAX ?? BAYES_WARM_START_RHAT_MAX,
    BAYES_WARM_START_ESS_MIN: forecasting?.BAYES_WARM_START_ESS_MIN ?? BAYES_WARM_START_ESS_MIN,
    BAYES_HDI_PROB: forecasting?.BAYES_HDI_PROB ?? BAYES_HDI_PROB,
    BAYES_DRAWS: forecasting?.BAYES_DRAWS ?? BAYES_DRAWS,
