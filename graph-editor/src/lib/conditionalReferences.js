 ...
 */
export function generateConditionalReference(edgeSlug, nodeSlugs, param) {
 ...
 */
export function parseConditionalReference(reference) {
 ...
 */
export function getEdgeConditionalReferences(edge, graph) {
    const references = [];
    if (!edge.slug) {
 ...
 */
export function getAllConditionalReferences(graph) {
    const allReferences = [];
 ...
 */
export function findConditionalProbabilityByReference(reference, graph) {
 ...
 */
export function validateSlugUniqueness(graph) {
    const nodeSlugs = new Map();
    const edgeSlugs = new Map();
    const nodesWithoutSlugs = [];
    const edgesWithoutSlugs = [];
    // Check node slugs
