 ...
 */
export function getConditionSignature(edge) {
 ...
 */
export function getConditionalColor(edge) {
 ...
 */
export function getUsedColors(graph) {
    const used = new Set();
    if (!graph)
        return used;
 ...
 */
export function getNextAvailableColor(graph) {
 ...
 */
export function getSiblingEdges(edge, graph) {
    if (!graph)
        return [];
 ...
 */
export function getSharedConditionSignature(edges) {
    if (edges.length === 0)
        return '';
 ...
 */
export function assignColorToConditionalEdge(edge, graph, customColor) {
