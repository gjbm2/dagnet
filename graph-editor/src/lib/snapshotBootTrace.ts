...
export function isSnapshotBootChart(analysis: any): boolean {
  ...
  if (analysisType === 'cohort_maturity' || analysisType === 'cohort_maturity_v1' || analysisType === 'cohort_maturity_v2' || analysisType === 'daily_conversions' || analysisType === 'conversion_rate' || analysisType === 'lag_fit') {
    return true;
  }
