...
class LatencyConfig(BaseModel):
    ...
    promoted_mu_sd: Optional[float] = Field(None, ge=0, description="Posterior SD of promoted μ (from model_vars)")
    promoted_sigma_sd: Optional[float] = Field(None, ge=0, description="Posterior SD of promoted σ (from model_vars)")
    promoted_onset_sd: Optional[float] = Field(None, ge=0, description="Posterior SD of promoted onset (from model_vars)")
    promoted_onset_mu_corr: Optional[float] = Field(None, description="Posterior correlation onset↔μ (identifiability diagnostic)")
    promoted_path_mu_sd: Optional[float] = Field(None, ge=0, description="Posterior SD of promoted path μ (from model_vars)")
    promoted_path_sigma_sd: Optional[float] = Field(None, ge=0, description="Posterior SD of promoted path σ (from model_vars)")
    promoted_path_onset_sd: Optional[float] = Field(None, ge=0, description="Posterior SD of promoted path onset (from model_vars)")
